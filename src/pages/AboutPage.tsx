...
export default function AboutPage() {
  return (
    <>
      <Helmet>
        <title>About VitalMetrics | Medical Calculator Suite</title>
        <meta name="description" content="Learn about VitalMetrics, our mission to provide accurate medical calculators, and our commitment to healthcare professionals worldwide." />
      </Helmet>
