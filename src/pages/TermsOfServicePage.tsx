...
export default function TermsOfServicePage() {
  return (
    <>
      <Helmet>
        <title>Terms of Service | VitalMetrics</title>
        <meta name="description" content="Read VitalMetrics terms of service. Understand our terms and conditions for using our medical calculator suite." />
      </Helmet>
